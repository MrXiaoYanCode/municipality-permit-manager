...
export function AuthLayout({ children, title, subtitle }: AuthLayoutProps) {
  return (
    <div className="flex min-h-screen flex-col lg:flex-row">
      {/* Visual panel — hidden on small screens, shown lg+ */}
      ...
      <div className="relative flex flex-1 flex-col">
        ...
        <div className="flex items-center justify-between border-b border-border/50 px-6 py-4 lg:border-none lg:px-10 lg:pt-8">
          ...
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-full border border-border bg-card transition-all group-hover:border-primary group-hover:bg-primary/10">
